  ...
  const handlePlaceOrder = () => {
    if (name !== '' && phone !== '') {
      ...
      if (pickupOption === 'ASAP') {
        ...
        let hour = parseInt(defaultTime.substring(0, 2), 10);
        const minutes = defaultTime.substring(3, 5);
...
function Confirmation({ pickupTime, name, phone, orderQuantity, totalPrice }) {
  return (
